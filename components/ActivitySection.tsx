      ...
      <div className="mx-auto w-full max-w-6xl px-6">
        <div className="rounded-3xl border border-white/30 bg-white/60 p-6 shadow-blue-soft transition supports-[backdrop-filter]:bg-white/50 supports-[backdrop-filter]:backdrop-blur-md sm:p-12">
          ...
          <div className="space-y-4 text-center sm:text-left">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-2 sm:justify-start bg-white/40 p-1.5 rounded-full w-fit mx-auto sm:mx-0 border border-white/40">
              {[
                ...
                <button
                  ...
                  className={`px - 6 py - 2 rounded - full text - sm font - medium transition - all duration - 300 relative ${activeTab === tab.id
